...
if isa(Img,'uint8')
    ...
    Win = double(MaxV) - double(MinV);
    WLAdjCoe = (Win + 1)/1024;
    disp('The type of is image is uint8');
elseif isa(Img,'uint16')
    ...
    Win = double(MaxV) - double(MinV);
    WLAdjCoe = (Win + 1)/1024;
    disp('The type of is image is uint16');
elseif isa(Img,'uint32')
    ...
    Win = double(MaxV) - double(MinV);
    WLAdjCoe = (Win + 1)/1024;
    disp('The type of is image is uint32');
...
elseif isa(Img,'int8')
    ...
    Win = double(MaxV) - double(MinV);
    WLAdjCoe = (Win + 1)/1024;
    disp('The type of is image is int8');
elseif isa(Img,'int8')
    MaxV = int8(Inf);
    MinV = int8(-Inf);
    LevV = (double( MaxV) + double(MinV)) / 2;
    ...
    WLAdjCoe = (Win + 1)/1024;
    disp('The type of is image is int8');
elseif isa(Img,'int12')
    MaxV = 4095;
    MinV = -4095;
    LevV = (double( MaxV) + double(MinV)) / 2;
    Win = double(MaxV) - double(MinV);
    WLAdjCoe = (Win + 1)/1024;
    disp('The type of is image is int12');
elseif isa(Img,'int32')
    ...
    Win = double(MaxV) - double(MinV);
    WLAdjCoe = (Win + 1)/1024;
    disp('The type of is image is int32');
elseif isa(Img,'int64')
    ...
    Win = double(MaxV) - double(MinV);
    WLAdjCoe = (Win + 1)/1024;
    disp('The type of is image is int64');
